...
declare namespace ItemData {
        ...
        wk_items: {
          ...
          filters: {
            ...
            item_type: {
              ...
              filter_value_map: (
                filter_value: SubjectTypeShort[] | SubjectTypeShortString,
              ) => {
                [key: string]: boolean;
              };
              filter_func: (
                filter_value: { [key: string]: boolean },
                item: Item,
              ) => boolean;
            } & Filter<any>;
            level: {
              ...
              filter_value_map: (filter_value: string) => {
                [key: number]: boolean;
              };
              filter_func: (
                filter_value: { [key: number]: boolean },
                item: Item,
              ) => boolean;
            } & Filter<any>;
            srs: {
              ...
              filter_value_map: (filter_value: string | SrsName[]) => {
                [key: string]: boolean;
              };
              filter_func: (
                filter_value: { [key: string]: boolean },
  ...
  export type Module = {
    ItemData: {
      ...
      get_index: <T = Item[] | Item>(
        items: Item[],
        index_name: IndexOptions,
      ) => { [key: string]: T };
...
declare namespace Settings {
  ...
  type List = {
    ...
    | { multi?: false; default?: string }
    | { multi?: true; default: { [key: string]: boolean } }
  ) &
    ComponentDefaults;
